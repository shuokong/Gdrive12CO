...
os.system('rm color_12co_NH_tdust.pdf')
plt.savefig('color_12co_NH_tdust.pdf',dpi=400)
os.system('open color_12co_NH_tdust.pdf')
os.system('cp color_12co_NH_tdust.pdf ~/GoogleDrive/imagesSFE/')
#plt.show()

...
#hdu1 = fits.open('mask_regrid_peak_12co_CARMAonly_pix_1_Tmb.fits')[0]
hdu1 = fits.open('subregion_mask_regrid_peak_12co_CARMAonly_pix_1_Tmb.fits')[0]
...
if peak == 1:
    ...
    ff.set_title('CARMA',fontsize=20)
    ...
    pdfname = 'mask_regrid_peak_12co_CARMAonly_pix_1_Tmb.pdf'

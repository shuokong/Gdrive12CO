...
#hdu1 = fits.open('peak_12co_pix_2_Tmb.fits')[0]
hdu1 = fits.open('subregion_peak_12co_pix_2_Tmb.fits')[0]
...
if peak == 1:
    ...
    ff.set_title('NRO45+CARMA',fontsize=20)
    ...
    pdfname = 'application_peak_12co_pix_2_Tmb.pdf'

...
if ($images) then
  ...
  moment in=products/mask_imfit_12co_pix_2_Tmb.mir mom=-2 out=products/peak_12co_pix_2_Tmb.mir
...
if ($mom0) then
  ...
  moment in=products/mask_imfit_12co_pix_2_Tmb.mir mom=0 region="kms,images(2.5,15)" out=products/mom0_12co_pix_2_Tmb.mir
...
if ($velocityrange) then
  ...
  moment in=products/mask_imfit_12co_pix_2_Tmb.mir mom=0 out=products/${mom0name}_12co_pix_2_Tmb.mir region=${mom0region}
...
if ($mom1three) then
  ...
  moment in=products/clip3sigma_mask_imfit_12co_pix_2_Tmb.mir mom=1 out=products/mom1_12co_pix_2_Tmb.mir 
...
if ($mom1five) then
  rm -rf products/mom1_12co_pix_2_Tmb.mir
  moment in=products/clip5sigma_mask_imfit_12co_pix_2_Tmb.mir mom=1 out=products/mom1_12co_pix_2_Tmb.mir 
  fits in=products/mom1_12co_pix_2_Tmb.mir op=xyout out=products/mom1_12co_pix_2_Tmb.fits
endif
...
if ($mom2three) then
  ...
  moment in=products/clip3sigma_mask_imfit_12co_pix_2_Tmb.mir mom=2 out=products/mom2_12co_pix_2_Tmb.mir 
...
if ($mom2five) then
  rm -rf products/mom2_12co_pix_2_Tmb.mir
  moment in=products/clip5sigma_mask_imfit_12co_pix_2_Tmb.mir mom=2 out=products/mom2_12co_pix_2_Tmb.mir 
  fits in=products/mom2_12co_pix_2_Tmb.mir op=xyout out=products/mom2_12co_pix_2_Tmb.fits
endif
